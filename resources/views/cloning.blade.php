                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item active bg-purple" type="button"><small>Latest (5.3.x)
                        ...
                        <li class="nav-item">
                            <!-- dropdown -->
                            <div class="dropdown" data-bs-theme="light">
                                <button type="button" class="btn nav-link text-white dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><button class="dropdown-item active bg-purple" type="button">
                                        <small><i class="bi-brightness-high-fill me-2"></i>Light</small></button></li>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/bs-themes.png')}}" alt="BootstrapThemes">
                </div>
            </div>
        </div>
    </div>
